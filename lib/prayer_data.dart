  ...
  static Map<String, List<PrayerStep>> masterPrayerDB = {
    ...
    'Prayer of St. Francis': [
      PrayerStep(
        ...
        contentAm:
            'ጌታ ሆይ የሰላም መሳሪያ እንድሆን አድርገኝ፤ ጥል ባለበት ፍቅር፣ በደል ባለበት ይቅርታ፣ ክርክር ባለበት ስምምነት፣ ጥርጣሬ ባለበት እምነት፣ ስህተት ባለበት እዉነት፣ ተስፋ መቁረጥ ባለበት መጽናናት፣ ሓዘን ባለበት ደስታ፣ ጨለማ ባለበት ብርሃን እንዲገኝ አደርግ ዘንድ አብቃኝ፡፡',
      ...
      PrayerStep(
        ...
        contentAm:
            'ከመቀበል መስጠት፣ ይቅር ለመባል ይቅር ማለት፣ የዘለዓለም ሕይወት ለማግኘት መሞት እንዳለብኝ ለማወቅ እርዳኝ፡፡ አሜን፡፡',
        imagePath: 'assets/St. Francis.jpg',
      ),
    ],
    ...
    'The Guardian Angel Prayer': [
      PrayerStep(
        ...
        contentAm:
            'ጠባቂዬ የሆንህ የእግዚአብሔር መልአክ ሆይ፣ አንተ እንድትጠብቀኝ በአምላክ ቸርነት ላንተ ተሰጥቼአለሁና፣',
        imagePath: 'assets/St. Francis.jpg',
      ),
      PrayerStep(
        sectionHeader: 'INVOCATION',
    ...
    'The Benedictus': [
      PrayerStep(
        ...
        contentAm:
            '68 የእስራኤል ጌታ አምላክ ይባረክ፥ ጐብኝቶ ለሕዝቡ ቤዛ አድርጎአልና፤ 69-70 ከጥንት ጀምሮ በነበሩት በቅዱሳን ነቢያት አፍ እንደ ተናገረ፥ በብላቴናው በዳዊት ቤት የመዳን ቀንድን አስነስቶልናል፤ 71 ማዳኑም ከወደረኞቻችንና ከሚጠሉን ሁሉ እጅ ነው፤',
      ...
      PrayerStep(
        ...
        contentAm:
            '72-73 እንደዚህ ለአባቶቻችን ምሕረት አደረገ፤ ለአባታችን ለአብርሃምም የማለውን መሐላውን ቅዱሱን ኪዳን አሰበ፤ 74-75 በእርሱም ከጠላቶቻችን እጅ ድነን በዘመናችን ሁሉ ያለ ፍርሃት በቅድስናና በጽድቅ በፊቱ እንድናገለግለው ሰጠን። 76 ደግሞም አንተ ሕፃን ሆይ፥ የልዑል ነቢይ ትባላለህ፥ መንገዱን ልትጠርግ በጌታ ፊት ትሄዳለህና፤ 77 እንደዚህም የኃጢአታቸው ስርየት የሆነውን የመዳን እውቀት ለሕዝቡ ትሰጣለህ፤',
        imagePath: 'assets/My Daily Journal.jpg',
      ),
      PrayerStep(
        sectionHeader: 'FINAL PETITION',
        ...
        contentAm:
            '78 ይህም ከላይ የመጣ ብርሃን በጐበኘበት በአምላካችን ምሕረትና ርኅራኄ ምክንያት ነው፤ 79 ብርሃኑም በጨለማና በሞት ጥላ ተቀምጠው ላሉት ያበራል እግሮቻችንንም በሰላም መንገድ ያቀናል። ለአብ፥ ለወልድና ለመንፈስ ቅዱስ ምስጋና ይሁን አሁንም ዘወትርም ለዘለዓለምም አሜን፡፡',
        imagePath: 'assets/My Daily Journal.jpg',
      ),
    ],
    ...
    'Act Of Contrition': [
      PrayerStep(
        ...
        contentAm:
            'አምላኬ ሆይ ፍጹም ተወዳጅ ነህ፣ ኃጢአትን የምትጠላ ነህ፤ በኃጢአቴ ስለበደልኩህ እጅግ አዝናለሁ፤ ማረኝ!',
        imagePath: 'assets/St. Francis.jpg',
      ),
      PrayerStep(
        sectionHeader: 'INVOCATION',
    ...
    'Prayer for the Hour of Mercy': [
      PrayerStep(
        ...
        contentEn:
            'V: You expired Jesus, but the source of life gushed forth for souls, and the ocean of mercy opened up for the whole world.',
      ...
      PrayerStep(
        ...
        titleAm: 'የምሕረት ሰዓት ጸሎት',
        contentEn:
            'All: O Fountain of Life, unfathomable Divine Mercy, envelop the whole world and empty Yourself out upon us.\n\nV: O Blood and Water which gushed forth from the Heart of Jesus as a fount of Mercy for us,\nAll: I trust in You.',
      ...
      PrayerStep(
        ...
        contentAm:
            'ይቅር ለመባል ይቅር ማለት፣ የዘለዓለም ሕይወት ለማግኘት መሞት እንዳለብኝ ለማወቅ እርዳኝ፡፡ አሜን፡፡',
        imagePath: 'assets/St. Francis.jpg',
      ),
    ],
    ...
    'The Memorare': [
      PrayerStep(
        ...
        contentAm:
            'እጅግ ርኅሩኅ ድንግል ማርያም ሆይ፤ ወደ አንቺ ጥገኝነት የሸሸ፣ ረድኤትሽን የለመነ ወይም አማላጅነትሽን የፈለገ ማንም ሰው ያለ ረዳት እንዳልቀረ በጭራሽ የተሰማ አለመሆኑን አስቢ።',
        imagePath: 'assets/sunrise.jpeg',
      ),
      PrayerStep(
        sectionHeader: 'INVOCATION',
        ...
        contentAm:
            'በዚህ እምነት ተደፋፍሬ፣ የደናግል ድንግል እናቴ ሆይ፣ ወደ አንቺ እመጣለሁ። በፊቶሽ እቆማለሁ፣ ኃጢአተኛና አዛኝ ነኝ።',
        imagePath: 'assets/sunrise.jpeg',
      ),
      PrayerStep(
        sectionHeader: 'FINAL PETITION',
        ...
        contentAm:
            'የሥጋ የለበሰው ቃል እናት ሆይ፣ ልመናዬን አትንቂ፣ በምሕረትሽ ስሚኝና መልሽልኝ እንጂ። አሜን።',
        imagePath: 'assets/sunrise.jpeg',
      ),
    ],
    ...
    'Prayer to Saint Joseph': [
      PrayerStep(
        ...
        contentAm:
            'ቅዱስ ዮሴፍ ሆይ፣ በእግዚአብሔር ዙፋን ፊት ጥበቃህ እጅግ ታላቅ፣ ፈጣንና ብርቱ የሆነ፣ ፍላጎቶቼንና ምኞቶቼን ሁሉ በአንተ ላይ አኖራለሁ። በኃያል አማላጅነትህ እርዳኝ፣ ከመለኮታዊ ልጅህም በመንፈሳዊ በረከቶች ሁሉ በጌታችን በኢየሱስ ክርስቶስ በኩል አሰጥኝ።',
        imagePath: 'assets/St. Francis.jpg',
      ),
      PrayerStep(
        sectionHeader: 'INVOCATION',
        ...
        titleAm: 'ወደ ቅዱስ ዮሴፍ ጸሎት',
        contentEn:
            'So that, having engaged here below your heavenly power, I may offer my thanksgiving and homage to the most loving of fathers. Oh, St. Joseph, I never weary contemplating you and Jesus asleep in your arms; I dare not approach while he reposes near your heart.',
        contentAm:
            'በዚህም በምድር ላይ ሰማያዊ ኃይልህን አግኝቼ፣ ከሁሉም አባቶች ይበልጥ ለሆንከው አፍቃሪ አባት ምስጋናዬንና ክብሬን አቀርባለሁ። ቅዱስ ዮሴፍ ሆይ፣ አንተንና በእቅፍህ የተኛውን ኢየሱስን ከመመልከት በጭራሽ አልሰለችም፤ በልብህ አቅራቢያ ሲያርፍ ለመቅረብ አልደፍርም።',
        imagePath: 'assets/St. Francis.jpg',
      ),
      PrayerStep(
        sectionHeader: 'FINAL PETITION',
        ...
        titleAm: 'ወደ ቅዱስ ዮሴፍ ጸሎት',
        contentEn:
            'Press him in my name and kiss his fine head for me and ask him to return the kiss when I draw my dying breath. St. Joseph, patron of departing souls - pray for me. Amen.',
        contentAm:
            'በስሜ እቀፈው፣ ውብ ራሱንም ሳምልኝ፣ እኔም የመጨረሻ ትንፋሼን ስተነፍስ ያንን ሳም እንዲመልስልኝ ለምነው። የሟች ነፍሳት ጠባቂ ቅዱስ ዮሴፍ ሆይ - ስለ እኔ ጸልይ። አሜን።',
        imagePath: 'assets/St. Francis.jpg',
      ),
    ],
    ...
    'Prayer to St. Francis of Assisi': [
      ...
      PrayerStep(
        ...
        contentEn:
            'O divine Master, grant that I may not so much seek\nto be consoled as to console,\nto be understood as to understand,\nto be loved as to love.\nFor it is in giving that we receive,\nit is in pardoning that we are pardoned,\nand it is in dying that we are born to eternal life. Amen.',
        contentAm:
            'ጌታ ሆይ ከማጽናናት ይልቅ ለማጽናናት፣ ከመረዳት ይልቅ ለመረዳት፣ ከመወደድ ይልቅ ለመውደድ እንድተጋ እርዳኝ። በመስጠት እናገኛለንና፣ ይቅር በማለት ይቅር እንባላለንና፣ በመሞትም ለዘላለም ሕይወት እንወለዳለንና። አሜን።',
        imagePath: 'assets/St. Francis.jpg',
      ),
    ],
    ...
    'The Litany of the Saints': [
      PrayerStep(
        ...
        contentAm:
            'ጌታ ሆይ ማረን። ክርስቶስ ሆይ ማረን። ጌታ ሆይ ማረን። ክርስቶስ ሆይ ስማን። የሰማይ አባት እግዚአብሔር ሆይ ማረን። ዓለምን ያዳንክ ወልድ እግዚአብሔር ሆይ ማረን። መንፈስ ቅዱስ እግዚአብሔር ሆይ ማረን። ቅድስት ሥላሴ አንድ አምላክ ሆይ ማረን።',
        imagePath: 'assets/St. Francis.jpg',
      ),
      PrayerStep(
        sectionHeader: 'INVOCATION',
        ...
        contentAm:
            'ቅድስት ማርያም ሆይ፣ ቅድስት የእግዚአብሔር እናት፣ ቅዱስ ሚካኤል፣ ቅዱስ ገብርኤል፣ ቅዱስ ሩፋኤል፣ ቅዱስ ዮሐንስ መጥምቅ፣ ቅዱስ ዮሴፍ፣ ቅዱስ ጴጥሮስና ጳውሎስ፣ ቅዱስ እስጢፋኖስ፣ ቅዱስ አውግስጢኖስ፣ ቅዱስ ፍራንቸስኮስ፣ ቅድስት ማርያም መግደላዊት፣ የእግዚአብሔር ቅዱሳንና ቅዱሳት ሁሉ ሆይ፤ ስለ እኛ ማልዱ።',
        imagePath: 'assets/St. Francis.jpg',
      ),
      PrayerStep(
        sectionHeader: 'FINAL PETITION',
    ...
    'Prayer of Abandonment': [
      PrayerStep(
        ...
        contentAm:
            'አባቴ ሆይ፤ ራሴን በእጆችህ ላይ አኖራለሁ፤ በኔ የምትፈልገውን ሁሉ አድርግ። ለምታደርገው ነገር ሁሉ አመሰግንሃለሁ፤ ለሁሉም ዝግጁ ነኝ፣ ሁሉንም እቀበላለሁ።',
        imagePath: 'assets/St. Francis.jpg',
      ),
      PrayerStep(
        sectionHeader: 'INVOCATION',
        ...
        contentAm:
            'ጌታ ሆይ፤ በአንተ ፈቃድ ብቻ በእኔና በፍጥረታትህ ሁሉ ላይ ይፈጸም - ከዚህ ውጪ ሌላ ምንም አልመኝም።',
        imagePath: 'assets/St. Francis.jpg',
      ),
      PrayerStep(
        sectionHeader: 'FINAL PETITION',
        ...
        contentAm:
            'ነፍሴን በእጆችህ አደራ እሰጣለሁ፤ በልቤ ፍቅር ሁሉ ለአንተ እሰጣታለሁ፤ ጌታ ሆይ እወድሃለሁና ራሴን ለአንተ መስጠት አለብኝ፣ ያለምንም ገደብና ወሰን በሌለው እምነት ራሴን በእጆችህ ላይ አሳልፌ እሰጣለሁ፣ አንተ አባቴ ነህና።',
        imagePath: 'assets/St. Francis.jpg',
      ),
    ],
    ...
    'Anima Christi': [
      PrayerStep(
        ...
        contentAm:
            'የክርስቶስ ነፍስ ሆይ፣ ቀድሺኝ። የክርስቶስ ሥጋ ሆይ፣ አድኚኝ። የክርስቶስ ደም ሆይ, አርኪኝ። ከክርስቶስ ጎን የፈሰሰው ውኃ ሆይ፣ እጠቢኝ። የክርስቶስ መከራ ሆይ፣ አበርቺኝ።',
        imagePath: 'assets/St. Francis.jpg',
      ),
      PrayerStep(
        sectionHeader: 'INVOCATION',
        ...
        titleAm: 'የክርስቶስ ነፍስ ሆይ',
        contentEn:
            'O good Jesus, hear me. Within Thy Wounds hide me. Suffer me not to be separated from Thee. From the malignant enemy, defend me.',
        contentAm:
            'ቸሩ ኢየሱስ ሆይ፣ ስማኝ። በቆሰሉት ቁስሎችህ ውስጥ ደብቀኝ። ከአንተ እንድለይ አትፍቀድብኝ። ከክፉ ጠላት ጠብቀኝ።',
        imagePath: 'assets/St. Francis.jpg',
      ),
      PrayerStep(
        sectionHeader: 'FINAL PETITION',
        ...
        titleAm: 'የክርስቶስ ነፍስ ሆይ',
        contentEn:
            'In the hour of my death, call me, And bid me to come to Thee. That with Thy saints, I may praise Thee. Forever and ever. Amen.',
        contentAm:
            'በሞቴ ሰዓት ጥራኝ፣ ወደ አንተም እንድመጣ እዘዘኝ። ከቅዱሳንህ ጋር ለዘላለም አመሰግንህ ዘንድ። አሜን።',
        imagePath: 'assets/St. Francis.jpg',
      ),
    ],
    ...
    'Litany of the Holy Name of Jesus': [
      PrayerStep(
        ...
        contentEn:
            'Lord, have mercy on us. Christ, have mercy on us. God the Father of Heaven, have mercy on us. God the Son, Redeemer of the world, have mercy on us. God the Holy Spirit, have mercy on us. Holy Trinity, one God, have mercy on us. Jesus, Son of the living God, have mercy on us. Jesus, King of glory, sun of justice, brightness of eternal light, have mercy on us.',
        contentAm:
            'ጌታ ሆይ ማረን። ክርስቶስ ሆይ ማረን። የሰማይ አባት እግዚአብሔር ሆይ ማረን። ዓለምን ያዳንክ ወልድ እግዚአብሔር ሆይ ማረን። መንፈስ ቅዱስ እግዚአብሔር ሆይ ማረን። ቅድስት ሥላሴ አንድ አምላክ ሆይ ማረን። የሕያው እግዚአብሔር ልጅ ኢየሱስ ሆይ ማረን። የክብር ንጉሥ፣ የጽድቅ ፀሐይ፣ የዘላለም ብርሃን የሆንክ ኢየሱስ ሆይ ማረን።',
        imagePath: 'assets/St. Francis.jpg',
      ),
      PrayerStep(
        sectionHeader: 'INVOCATION',
        ...
        titleAm: 'የኢየሱስ ቅዱስ ስም ሊታንያ (ክፍል ፪)',
        contentEn:
            'Jesus, most powerful, most patient, most obedient, meek and humble of heart. Jesus, lover of us, God of peace, author of life, our refuge, father of the poor, good Shepherd, true light, eternal wisdom, our way and our life. Be merciful, spare us, O Jesus. Be merciful, graciously hear us, O Jesus.',
        contentAm:
            'ሁሉን የምትችል፣ ታጋሽ፣ ታዛዥ፣ ልብህ የዋህና ትሑት የሆንክ ኢየሱስ ሆይ። እኛን የምትወድ፣ የሰላም አምላክ፣ የሕይወት መሥራች፣ መጠጊያችን፣ የድሆች አባት፣ መልካም እረኛ፣ እውነተኛ ብርሃን፣ የዘላለም ጥበብ፣ መንገዳችንና ሕይወታችን የሆንክ ኢየሱስ ሆይ። ማረን፣ ይቅር በለን ኢየሱስ ሆይ።',
        imagePath: 'assets/St. Francis.jpg',
      ),
      PrayerStep(
        sectionHeader: 'FINAL PETITION',
        ...
        titleAm: 'የኢየሱስ ቅዱስ ስም ሊታንያ (ክፍል ፫)',
        contentEn:
            'From all evil, deliver us, O Jesus. From all sin, deliver us, O Jesus. By Your agony and passion, Your cross and sufferings, Your death and burial, Your Resurrection and Ascension, deliver us. Lamb of God, who takest away the sins of the world, have mercy on us. O Lord Jesus Christ, grant us the gift of Your most divine love. Amen.',
        contentAm:
            'ከክፉ ሁሉ፣ ከኃጢአትም ሁሉ አድነን ኢየሱስ ሆይ። በሕማማትህ፣ በስቅላትህ፣ በሞትህና በትንሣኤህ አድነን። የዓለምን ኃጢአት የምታስወግድ የእግዚአብሔር በግ ሆይ፣ ማረን። ጌታ ኢየሱስ ክርስቶስ ሆይ፣ የመለኮታዊ ፍቅርህን ስጦታ ስጠን። አሜን።',
        imagePath: 'assets/St. Francis.jpg',
      ),
    ],
    ...
    'Come, Holy Spirit': [
      ...
      PrayerStep(
        ...
        contentAm:
            'የታመኑትን ልብ በመንፈስ ቅዱስ ብርሃን ያስተማርክ እግዚአብሔር አምላክ ሆይ፤ በእርሱ መንፈስ እውነተኛ ጥበበኞች እንድንሆንና ሁልጊዜ በመጽናናቱ ደስ እንዲለን ስጠን። በክርስቶስ በጌታችን። አሜን።',
        imagePath: 'assets/St. Francis.jpg',
      ),
    ],
    ...
    'Hail Holy Queen': [
      PrayerStep(
        ...
        contentAm:
            'ሰላም ላንቺ ይሁን እመቤታችን፣ የምሕረት እናት፣ ሕይወታችን፣ ጣፋጭነታችንና ተስፋችን ሆይ ሰላም ላንቺ ይሁን። እኛ የተሰደድን የሔዋን ልጆች ወደ አንቺ እንጮኻለን።',
        imagePath: 'assets/St. Francis.jpg',
      ),
      PrayerStep(
        sectionHeader: 'INVOCATION',
        ...
        titleAm: 'ሰላም ላንቺ ይሁን ንግሥት ሆይ',
        contentEn:
            'To you do we send up our sighs, mourning and weeping in this valley of tears. Turn then, most gracious advocate, your eyes of mercy toward us,',
        contentAm:
            'በዚህ በለቅሶ ሸለቆ ውስጥ እየተጨነቅንና እያለቀስን ትንፋሻችንን ወደ አንቺ እንልካለን። እንግዲህ፣ አቅኚ ጠበቃችን ሆይ፣ የምሕረት ዓይኖችሽን ወደ እኛ መልሽ፤',
        imagePath: 'assets/St. Francis.jpg',
      ),
      PrayerStep(
        sectionHeader: 'FINAL PETITION',
        ...
        titleAm: 'ሰላም ላንቺ ይሁን ንግሥት ሆይ',
        contentEn:
            'and after this exile show unto us the blessed fruit of thy womb, Jesus. O clement, O loving, O sweet Virgin Mary. Amen.',
        contentAm:
            'ከዚህ ስደት በኋላም የተባረከውን የሆድሽን ፍሬ ኢየሱስን አሳዪን። አንቺ ርኅሩኅ፣ አፍቃሪ፣ ጣፋጭ ድንግል ማርያም ሆይ። አሜን።',
        imagePath: 'assets/St. Francis.jpg',
      ),
    ],
  };
