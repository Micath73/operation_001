...
import 'package:operation_001/psalm_model.dart';

class MorningPsalmPage extends StatefulWidget {
  final bool isAmharic;

  const MorningPsalmPage({super.key, this.isAmharic = false});
...
class _MorningPsalmPageState extends State<MorningPsalmPage> {
  final List<PsalmModel> morningPsalms = [
    ...
    ‘Never shall they enter my rest.""",
      AmTitle: 'መዝሙረ ዳዊት 95',
      AmFullText: """1 ኑ፥ በእግዚአብሔር ደስ ይበለን፤ ለአምላክ ለመድኃኒታችን እልል እንበል።
...
11 ወደ ዕረፍቴም እንዳይገቡ በቁጣዬ ማልሁ።""",
    ...
    your right hand upholds me.""",
      ...
      AmFullText: """2 ኃይልህንና ክብርህን አይ ዘንድ እንዲሁ بالمቅደስ ውስጥ ተመለከትሁህ።
...
9 እነርሱ ግን ነፍሴን ለከንቱ ፈለጓት፤ ወደ ምድር ጥልቅ ይገባሉ።""",
    ...
    8 May God still give us his blessing
      ...
      AmFullText: """1 እግዚአብሔር ይማረን ይባርከንም፥ ፊቱንም በላያችን ያብራ፤
...
7 እግዚአብሔር ይባርከናል፥ የምድርም ዳርቻ ሁሉ ይፈሩታል።""",
    ...
    Then you will be offered young bulls on your altar.""",
      AmTitle: 'መዝሙረ ዳዊት 51',
      AmFullText: """1 አቤቱ፥ እንደ ቸርነትህ መጠን ማረኝ፤ እንደ ምሕረትህም ብዛት መተላለፌን ደምስስ።
...
19 የጽድቁን መሥዋዕት መባውንም የሚቃጠለውንም መሥዋዕት በወደድህ ጊዜ፥ ያን ጊዜ በመሠዊያህ ላይ ፍሪዳዎችን ይሠዋሉ።""",
    ...
    Alleluia!""",
      ...
      AmFullText: """1 ሃሌ ሉያ። ለእግዚአብሔር አዲሱን ቅኔ ተቀኙለት፤ ምስጋናው በቅዱሳኑ ጉባኤ ነው።
...
5 ቅዱሳን በክብር ይመካሉ፤ በምንጣፋቸውም ላይ ሐሤትን ያድርጉ።
...
9 የተጻፈውን ፍርድ ያደርጉባቸው ዘንድ። ለቅዱሳን ሁሉ ይህች ክብር ናት። ሃሌ ሉያ።""",
  ...
  protect him, for he knows my name.  15 When he calls on me, I will answer him;
  ...
  I will show him my saving power.""",
      AmTitle: 'መዝሙረ ዳዊት 91',
      AmFullText: """1 በልዑል መጠጊያ የሚኖር ሁሉን በሚችል አምላክ ጥላ ውስጥ ያድራል።
...
16 ረጅምን ዕድሜ አጠግበዋለሁ፥ ማዳኔንም አሳየዋለሁ።""",
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          widget.isAmharic ? 'የማለዳ መዝሙረ ዳዊት ጸሎቶች' : 'Morning Psalm Prayers',
        ...
        children: [
          ...
          SafeArea(
            child: ListView.builder(
              ...
              itemCount: morningPsalms.length,
              itemBuilder: (context, index) {
                final prayer = morningPsalms[index];
                final displayTitle = widget.isAmharic
                    ? (prayer.AmTitle ?? prayer.title)
                    : prayer.title;
                final displayText = widget.isAmharic
                    ? (prayer.AmFullText ?? prayer.fullText)
                    : prayer.fullText;
